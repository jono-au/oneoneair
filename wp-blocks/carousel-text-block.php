...
<div class="container-fluid carousel-text-block <?php echo $unique_id ?>" id="<?php the_field('unique_block_id') ?>">
<div class="container">
	<div class="row">
		<div class="col-lg-8">
		<?php
...
if( have_rows('carousel_repeater') ):
	$i = 0; 
	echo '<div id="carouselID'. $unique_id .'" class="carousel slide carousel-text-block1" data-ride="carousel">
